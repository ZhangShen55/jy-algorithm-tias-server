...
class InMemoryTiasRegistry:
    def __init__(self, key_prefix: str = "ai_quality:tias", default_ttl_seconds: int = 15):
...
class RedisTiasRegistry:
    def __init__(self, redis_url: str, key_prefix: str = "ai_quality:tias", default_ttl_seconds: int = 15):
        try:
            import redis
