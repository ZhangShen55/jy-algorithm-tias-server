...
set -euo pipefail
export CONFIG_PATH="${CONFIG_PATH:-/workspace/tias/config.toml}"
...
EOF
    ...
    exec uvicorn tias.main:app --host 0.0.0.0 --port 8881 --loop uvloop --workers "$WORKERS_PER_INSTANCE"
fi
